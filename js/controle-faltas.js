document.addEventListener('DOMContentLoaded', () => {
    const DADOS_DISCIPLINAS_FALTAS = {
        'iah': { percPorFalta: 2.78, nome: 'INTERAÇÃO AGENTE HOSPEDEIRO I' },
        'hm': { percPorFalta: 2.78, nome: 'HABILIDADES MÉDICAS II' },
        'iic': { percPorFalta: 2.78, nome: 'INICIAÇÃO À INVESTIGAÇÃO CIENTÍFICA' },
        'sa': { percPorFalta: 2.78, nome: 'SOCIOLOGIA E ANTROPOLOGIA II' },
